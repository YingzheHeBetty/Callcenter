...
//each call is a thread, when semaphore permits(available employee's number) > 0, the call can access FindCallHandler class, 
//otherwise the call will wait until permits > 0;
